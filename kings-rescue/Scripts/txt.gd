...
var ingame = {
	"start": ["An assassination plot has been uncovered! Click to select a Soldier and move them. Soldiers can push the King to escort him safely from the board-but beware, if an Assassin gets close, only a Soldier standing next to them can stop the deadly strike."],
 	"food": ["You gathered some Food. Running out of supplies leads to starvation, so this was a wise choice. If only it weren’t an apple...", "An apple a day, keeps the scurvy away.", "?elppA syawla ti si yhW", "Most of the Kings Guard prefers their apple peeled and sliced.", "Another apple? Oh wow, what a surprise. Truly, nature's bounty knows no limits.", "Imagine a world where different foods exist!", "Good news! You found food. Bad news? It's an apple.", "You take a bite of yet another apple. It tastes like resignation.", "You can see it in their faces - the slow, creeping starvation, turning warriors into scavengers, dignity into desperation. Yet, you feed them APPLE.", "Your struggles have truly blossomed into something special-too bad it’s just more apples.",  "Your efforts are really bearing fruit - just the same fruit. Over and over.", "Apple.", ],
